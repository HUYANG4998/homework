...
public class Aliyunsms {
    ...
    static final String accessKeyId = "LTAI4FiZCJNzVA6Lo5sh5mTr";
    static final String accessKeySecret = "SbwQ66tHeO5ie7A4jGh5fAlFU0DSjT";
    ...
    public static boolean sendVarifyMessage(String mobile, String code) {
        try {
            ...
            //必填:短信签名-可在短信控制台中找到
            request.setSignName("吉安小海豚婚车");
            //必填:短信模板-可在短信控制台中找到

            String msg = "{\"code\":\"" + code+"\"}";
            request.setTemplateParam(msg);//参数
            request.setTemplateCode("SMS_186947170");//模板id
